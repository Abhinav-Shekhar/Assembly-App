...
public class Adapter extends RecyclerView.Adapter<Adapter.PhoneViewHold>  {
    ...
    ArrayList<CartSlide> phoneLaocations;
    final private ListItemClickListener mOnClickListener;

    public Adapter(ArrayList<CartSlide> phoneLaocations, ListItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull PhoneViewHold holder, int position) {
        ...
        CartSlide CartSlide = phoneLaocations.get(position);
        holder.image.setImageResource(CartSlide.getImage());
        holder.title.setText(CartSlide.getTitle());
        holder.relativeLayout.setBackground(CartSlide.getgradient());
    }
